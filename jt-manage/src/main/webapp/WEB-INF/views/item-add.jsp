...
<script type="text/javascript">
	...
	function submitForm(){
		...
		//转化价格单位，将元转化为分    取值$(xxx).val();  赋值$(xxxx).val(100);
		//eval 将字符串转化为js对象  100*100
		...
		/*
			ajax中data格式写法
			1.{key:value,key2:value2} js对象方式
			2. key=value&key2=value2    字符串拼接方式
			$("#itemAddForm").serialize() 表单提交时简化JS取值步骤
		*/
